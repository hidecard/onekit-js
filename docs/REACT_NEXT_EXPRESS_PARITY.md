...
| Router and route rendering | **Implemented/experimental mix** | Streamed SSR route integration, richer route-specific loader/component inference, runtime layout/middleware composition, distributed ISR, and deployment adapter policy. |
