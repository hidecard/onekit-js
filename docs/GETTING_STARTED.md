...
OneKit JS V3.1.17 သည် browser အခြေပြု JavaScript/TypeScript application များအတွက် **reactivity, component lifecycle, virtual DOM, routing, storage, API helpers နှင့် SSR utilities** ကို package တစ်ခုအတွင်း ပေါင်းစည်းပေးသော framework-style library ဖြစ်သည်။ React လို component-oriented application များရေးနိုင်သော်လည်း React runtime ကို dependency အဖြစ် မလိုအပ်ပါ။
