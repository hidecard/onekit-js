...
| VDOM/JSX | VDOM/JSX helpers with keyed element reconciliation, fragments, refs, controlled input properties, and event cleanup | The first keyed reconciliation milestone is implemented and tested, including stable keyed-node moves across mixed keyed/unkeyed insertions and cleanup of removed keyed subtrees. Component-level reconciliation, keyed component identity, richer ref semantics, and hydration parity remain follow-up work. |
