...
export type FileRouteLoaderDataFor<Module> = Module extends {
    route?: {
        loader?: infer Loader;
    };
} ? Loader extends (...args: never[]) => infer Result ? Awaited<Result> : unknown : Module extends {
    loader?: infer Loader;
} ? Loader extends (...args: never[]) => infer Result ? Awaited<Result> : unknown : unknown;
export type FileRouteComponentPropsFor<Module> = Module extends {
    default?: infer Component;
} ? Component extends (props: infer Props) => unknown ? Props : unknown : unknown;
