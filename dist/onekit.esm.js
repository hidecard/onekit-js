...
export { API, DependencyInjector, OneKit, Router, VERSION, animations, announce, patch as apiPatch, bind, cache, create, createElement, createLandmarks, createSkipLink, createStorage, debounce, deepClone, del, destroy, di, generateId, get, getInstance, localStorage, makeFocusable, makeUnfocusable, manageTabOrder, mount, ok, pluginManager, post, put, reactive, register, render, request, router, sessionStorage, setAriaAttributes, skipToContent, throttle, trapFocus, validateAccessibility, patch$1 as vdomPatch, watch };
