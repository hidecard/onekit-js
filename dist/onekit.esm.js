...
export { API, DependencyInjector, OneKit, Router, VERSION, animations, announce, patch as apiPatch, autorun, batch, bind, cache, computed, create, createElement, createLandmarks, createSkipLink, createStorage, debounce, deepClone, del, destroy, di, effect, generateId, get, getInstance, localStorage, makeFocusable, makeUnfocusable, manageTabOrder, mount, ok, onDestroyed, onMounted, onPropsChanged, onUpdated, pluginManager, post, put, reactive, register, render, request, router, sessionStorage, setAriaAttributes, setupComponent, skipToContent, snapshot, throttle, trapFocus, validateAccessibility, patch$1 as vdomPatch, watch };
